...
resolve_asset_url() {
  local asset_name="$1"
  local api_url="https://api.github.com/repos/agentsray/zeroclaw/releases"
...
install_prebuilt_binary() {
  ...
  if [[ -z "$archive_url" ]]; then
    archive_url="https://github.com/agentsray/zeroclaw/releases/latest/download/${asset_name}"
  fi
...
run_docker_bootstrap() {
  ...
  fallback_image="ghcr.io/agentsray/zeroclaw:latest"
...
ROOT_DIR="$SCRIPT_DIR"
REPO_URL="https://github.com/agentsray/zeroclaw.git"
ORIGINAL_ARG_COUNT=$#
GUIDED_MODE="auto"
