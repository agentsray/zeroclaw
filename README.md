...
<p align="center">
  <img src="https://img.shields.io/badge/license-MIT%20OR%20Apache%202.0-blue.svg" alt="License: MIT OR Apache-2.0" />
  <a href="https://github.com/agentsray/zeroclaw/graphs/contributors"><img src="https://img.shields.io/github/contributors/agentsray/zeroclaw?color=green" alt="Contributors" /></a>
...
<p align="center">
  ...
  <a href="https://raw.githubusercontent.com/agentsray/zeroclaw/master/install.sh">One-Click Setup</a> |
...
| ---------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-02-19 | _Critical_  | We are **not affiliated** with `openagen/zeroclaw`, `zeroclaw.org` or `zeroclaw.net`. The `zeroclaw.org` and `zeroclaw.net` domains currently points to the `openagen/zeroclaw` fork, and that domain/repository are impersonating our official website/project.                                                                                       | Do not trust information, binaries, fundraising, or announcements from those sources. Use only [this repository](https://github.com/agentsray/zeroclaw) and our verified social accounts.                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2026-02-21 | _Important_ | Our official website is now live: [zeroclawlabs.ai](https://zeroclawlabs.ai). Thanks for your patience while we prepared the launch. We are still seeing impersonation attempts, so do **not** join any investment or fundraising activity claiming the ZeroClaw name unless it is published through our official channels.                            | Use [this repository](https://github.com/agentsray/zeroclaw) as the single source of truth. Follow [X (@zeroclawlabs)](https://x.com/zeroclawlabs?s=21), [Facebook (Group)](https://www.facebook.com/groups/zeroclaw), and [Reddit (r/zeroclawlabs)](https://www.reddit.com/r/zeroclawlabs/) for official updates. |
...
```bash
curl -LsSf https://raw.githubusercontent.com/agentsray/zeroclaw/master/install.sh | bash
```
...
git clone https://github.com/agentsray/zeroclaw.git
cd zeroclaw
./install.sh
...
```bash
curl -fsSL https://raw.githubusercontent.com/agentsray/zeroclaw/master/install.sh | bash
```
...
<https://github.com/agentsray/zeroclaw/releases/latest>

Example (ARM64 Linux):

```bash
curl -fsSLO https://github.com/agentsray/zeroclaw/releases/latest/download/zeroclaw-aarch64-unknown-linux-gnu.tar.gz
...
For detailed configuration of custom OpenAI-compatible and Anthropic-compatible endpoints, see the provider configuration in [docs/reference/api/providers-reference.md](docs/reference/api/providers-reference.md).
...
> https://github.com/agentsray/zeroclaw
...
If you encounter impersonation or trademark misuse, please [open an issue](https://github.com/agentsray/zeroclaw/issues).
...
| License | Use case |
|---|---|
You may choose either license. **Contributors automatically grant rights under both**.

### Trademark

The **ZeroClaw** name and logo are trademarks of ZeroClaw Labs. This license does not grant permission to use them to imply endorsement or affiliation.

### Contributor Protections

- You **retain copyright** of your contributions
- **Patent grant** (Apache 2.0) shields you from patent claims by other contributors
- Your contributions are **permanently attributed** in commit history
- No trademark rights are transferred by contributing

## Contributing

New to ZeroClaw? Look for issues labeled [`good first issue`](https://github.com/agentsray/zeroclaw/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).

Implement a trait, submit a PR:
...
<a href="https://github.com/agentsray/zeroclaw/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=agentsray/zeroclaw" alt="ZeroClaw contributors" />
</a>

## Star History

<p align="center">
  <a href="https://www.star-history.com/#agentsray/zeroclaw&type=date&legend=top-left">
    <picture>
     <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=agentsray/zeroclaw&type=date&theme=dark&legend=top-left" />
     <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=agentsray/zeroclaw&type=date&legend=top-left" />
     <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=agentsray/zeroclaw&type=date&legend=top-left" />
    </picture>
  </a>
</p>
